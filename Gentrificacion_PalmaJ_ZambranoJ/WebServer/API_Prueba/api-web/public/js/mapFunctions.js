    ...
    function cambioCapa(arreglo) {
        ...
        function alistarGentrificacionBarrios(capa,capa1,anio1,anio2){
            ...
            var query = new QueryR();
            query.outFields = ["T_PE_25_B","P_POBR_B","T_PE_EG_B","T_PE_ES_B"];
            query.where = "1=1";
            query.num = 50;
        ...
        function crearGraficoDobleBarra(resultados,resultados1,anio1,anio2){
            ...
            var data = {
                datasets:[{
                    label:'Total '+anio1,
                    data:[resultados.T_PE_25_B,resultados.P_POBR_B,resultados.T_PE_EG_B,resultados.T_PE_ES_B],
                    backgroundColor: ["#066F6C","#066F6C","#066F6C","#066F6C"],
                    borderColor: ["#ffffff","#ffffff","#ffffff","#ffffff"],
                    borderWidth: [1,1,1,1]
                },{
                    label:'Total '+anio2,
                    data: [resultados1.T_PE_25_B,resultados1.P_POBR_B,resultados1.T_PE_EG_B,resultados1.T_PE_ES_B],
                    backgroundColor: ["#f3b309","#f3b309","#f3b309","#f3b309"],
                    borderColor: ["#ffffff","#ffffff","#ffffff","#ffffff"],
                    borderWidth: [1,1,1,1]
                }],

                labels:[
                    "Personas > 25 años","Total Pobreza","Personas con empleo gerencial","Personas con Educación Superior"
        ...
        function alistarGentrificacionSectores(capa,capa1,anio1,anio2) {
            ...
            var query = new QueryR();
            query.outFields = ["T_PE_25_S", "T_PE_ES_S", "T_PE_EG_S", "PROM_POBR"];
            query.where = "1=1";
            query.num = 50;
        ...
        function crearGraficoDobleBarraSectores(resultados,resultados1,anio1,anio2){
            ...
            var data = {
                datasets:[ {
                    label:'Total '+anio1,
                    data:[resultados.T_PE_25_S,resultados.T_PE_ES_S,resultados.T_PE_EG_S,resultados.PROM_POBR],
                    backgroundColor: ["#066F6C","#066F6C","#066F6C","#066F6C","#066F6C"],
                    borderColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    borderWidth: [1,1,1,1,1]
                },{
                    label:'Total '+anio2,
                    data:[resultados1.T_PE_25_S,resultados1.T_PE_ES_S,resultados1.T_PE_EG_S,resultados1.PROM_POBR],
                    backgroundColor: ["#f3b309","#f3b309","#f3b309","#f3b309","#f3b309"],
                    borderColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    borderWidth: [1,1,1,1,1]
                }],

                labels:[
                    "Personas > 25 años","Personas con Educacion Superior","Personas con empleo gerencial","Total Pobreza"
